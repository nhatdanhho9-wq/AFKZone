...
class _LicenseInfoPageState extends State<LicenseInfoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('ThÃ´ng tin License'),
        backgroundColor: Colors.deepPurple,
      ),
      body: _isLoading
          ? Center(child: CircularProgressIndicator())
          : _licenseKey == null
              ? Center(child: Text('ChÆ°a cÃ³ license'))
                              ...
                              ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('ÄÃ£ copy license key')),
                                  );
                                },
                              ),
                            ],
  ...
  void _showRenewDialog() async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Chá»n gÃ³i gia háº¡n'),
        content: Container(
