...
declare module 'vscode' {
	...
	export interface InlineCompletionContext {
		...
		/**
		 * The completion ID associated with the currently displayed completion.
		*/
		readonly activeCompletionId?: string;
		/**
		 * The intellisense suggestions at the time of inline completion request.
		*/
		readonly intellisenseSuggestions?: SelectedCompletionInfo[];
	}
	...
	export interface SelectedCompletionInfo {
		...
		/**
		 * The additional information about the completion item.
		 */
		readonly additionalInfo?: antigravityAdditionalSelectedCompletionInfo;
	}

	/**
	 * Additional information about the completion item.
	 */
	export interface antigravityAdditionalSelectedCompletionInfo {
		/**
		 * The label of the completion item.
		 */
		readonly label?: string | CompletionItemLabel;

		/**
		 * Details such as function signature
		 */
	...
	export enum InlineCompletionTriggerKind {
		...
		/**
		 * Antigravity-specific: indicates that completion was triggered (automatically or explicitly) while
		 * the cursor was in the range of an Interactive Cascade suggested action's replacement range.
		 */
		WithCursorInSuggestedActionRange = 2,
	}
	...
	/**
	 * Represents a diagnostic with its associated quick fixes.
	 */
	export interface DiagnosticWithFixes {
		/**
		 * The diagnostic for which quick fixes are available.
		 */
		diagnostic: Diagnostic;

		/**
		 * An array of strings representing the available quick fixes descriptions and its ids.
		 */
		fixes: {
			/**
			 * The unique id of codeActionItem that related to this quick fix.
			 */
			id: string;
			/**
	...
	export namespace env {
		...
		/**
		 * The base application name of the editor. TODO:(Rohan) Consolidate with appName as it seems the same.
		 */
		export const appNameShort: string;

		/**
		 * The application name of the editor (might include quality) e.g. 'Jetski - Insiders'.
		 */
	...
	export interface TerminalOptions {
		...
		/**
		 * Whether this terminal is created for use in the Cascade UI. Only relevant if `hideFromUser` set to
		 * true.
		 */
		forCascadeUi?: boolean;
	...
	export namespace languages {
		...
		/**
		 * Get all diagnostics with their associated quick fixes for a given resource.
		 *
		 * @param resource A resource
		 * @returns A promise that resolves to an array of {@link DiagnosticWithFixes diagnostics with fixes} objects or an empty array.
		 */
		export function getDiagnosticsWithFixes(resource: Uri): Thenable<ReadonlyArray<DiagnosticWithFixes>>;

		/**
		 * Get all diagnostics with their associated quick fixes.
		 *
		 * @returns A promise that resolves to an array of uri-diagnostics-with-fixes tuples or an empty array.
		 */
		export function getDiagnosticsWithFixes(): Thenable<ReadonlyArray<[Uri, DiagnosticWithFixes[]]>>;

		/**
		 * Apply a code action.
		 * actionId: The identifier of the code action to apply.
		 * @returns A promise that resolves when the code action has been applied
		 */
		export function applyCodeAction(actionId: string): Thenable<void>;

		/**
		 * Clear all code actions that have been set.
		 */
	...
	export interface SourceControlResourceDecorations extends SourceControlResourceThemableDecorations {
		...
		/**
		 * The letter for a status (e.g. M for modified, A for added, ...)
		 * {@link SourceControlResourceState source control resource state}.
		 */
	...
	/**
	 * The tab represents a Jetski artifact.
	 */
	export class TabInputJetskiArtifacts {
		/**
		 * The source uri of the artifact.
		 */
		readonly sourceUri: Uri;
		/**
		 * Constructs a Jetski artifacts tab input.
		 * @param sourceUri The source uri of the artifact.
		 */
	...
	export interface Tab {
		 ...
		 */
		readonly input: TabInputText | TabInputTextDiff | TabInputCustom | TabInputJetskiArtifacts | TabInputWebview | TabInputNotebook | TabInputNotebookDiff | TabInputTerminal | unknown;
