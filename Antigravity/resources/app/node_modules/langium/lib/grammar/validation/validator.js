...
export class LangiumGrammarValidator {
    ...
    checkEmptyParserRule(parserRule, accept) {
        ...
        const consumesAnything = (element) => {
            ...
            if (ast.isRuleCall(element) && ((_a = element.rule.ref) === null || _a === void 0 ? void 0 : _a.definition)) {
    ...
    checkTerminalRuleReturnType(rule, accept) {
        var _a;
        if (((_a = rule.type) === null || _a === void 0 ? void 0 : _a.name) && !isPrimitiveGrammarType(rule.type.name)) {
...
function findLookAheadGroup(rule) {
...
function storeAssignmentUse(map, feature, increment, ...assignments) {
...
function mergeAssignmentUse(mapSoure, mapTarget, counterOperation = (s, t) => s + t) {
    ...
    mapSoure.clear();
}//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/94f91bc110994badc7c086033db813077a5226af/node_modules/langium/lib/grammar/validation/validator.js.map