    ...
    recurse(root, paths, end) {
        ...
        for (const path of paths) {
            ...
            if (node !== end && node.children.length > 0) {
                ...
                const subPaths = this.recurse(root, nextPaths, (_a = node.end) !== null && _a !== void 0 ? _a : end);
                all.push(...subPaths);
            }
            else {
                all.push(path);
...
export function collectInferredTypes(parserRules, datatypeRules, declared) {
...
function getRuleTypes(context, rule) {
    ...
    return flattenTypes(graph.getTypes(), (_a = type.end) !== null && _a !== void 0 ? _a : newTypePart());
}
...
}//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/94f91bc110994badc7c086033db813077a5226af/node_modules/langium/lib/grammar/type-system/type-collector/inferred-types.js.map